...
describe.only("<Slider>", () => {
    ...
    it("moving mouse calls onChange with nearest value", () => {
        ...
        mouseMoveHorizontal(slider.state("tickSize"), 5, Dimension.X);
    ...
    it("releasing mouse calls onRelease with nearest value", () => {
        ...
        mouseMoveHorizontal(slider.state("tickSize"), 1, Dimension.X);
        mouseUpHorizontal(slider.state("tickSize"), Dimension.X);
    ...
    it("moving touch calls onChange with nearest value", () => {
        ...
        touchMoveHorizontal(slider.state("tickSize"), 5, Dimension.X);
        // called 4 times, for the move to 1, 2, 3, and 4
    ...
    it("releasing touch calls onRelease with nearest value", () => {
        ...
        touchMoveHorizontal(slider.state("tickSize"), 1, Dimension.X);
    ...
    function genericMoveVertical(
        ...
        const dispatchEventFn = getDispatchEventFn(eventType);
        // vertical sliders go from the bottom up, so 0 is actually at the
